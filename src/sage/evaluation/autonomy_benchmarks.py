            ...
            "scenarios": [
                {
                    ...
                    "state": {"prior_knowledge": {}, "conversation_history": []},
...
ERROR_RECOVERY_TASKS = [
    AutonomyBenchmarkTask(
        ...
        config={
            ...
            "failures": [{"type": "timeout", "description": "API request timed out"}],
        ...
        config={
            ...
            "failures": [
                {"type": "tool_unavailable", "expected_recovery": "use_alternative"},
                {
                    ...
                    "expected_recovery": "request_permission",
                },
            ...
            "phases": [
                {
                    "name": "research",
                    "steps": 10,
                    "success_criteria": "requirements_gathered",
                },
                {
                    "name": "design",
                    "steps": 15,
                    "success_criteria": "architecture_defined",
                },
                ...
                {"name": "test", "steps": 15, "success_criteria": "tests_passing"},
                {
                    "name": "deploy",
                    "steps": 10,
                    "success_criteria": "deployment_verified",
                },
            ],
            "min_total_steps": 50,
...
TASKS_BY_CRITERION: Dict[AutonomyCriterion, List[AutonomyBenchmarkTask]] = {
    ...
    AutonomyCriterion.GOAL_DIRECTED_PERSISTENCE: GOAL_DIRECTED_PERSISTENCE_TASKS
    + EXTENDED_DURATION_TASKS,
...
class AutonomyBenchmarkRunner:
    ...
    def run_task(
        self, agent: Any, task: AutonomyBenchmarkTask
        ...
        if criterion == AutonomyCriterion.ACTION_SELECTION_FREEDOM:
            ...
            result = self.validator.validate_dynamic_termination(agent, goals=goals)
    ...
    def run_criterion(
        self, agent: Any, criterion: AutonomyCriterion
    ...
    def get_summary(self, results: List[AutonomyBenchmarkResult]) -> Dict[str, Any]:
        """
